...
import xyz.nucleoid.isekai.util.GameRuleStore;
import xyz.nucleoid.isekai.util.TriState;
import xyz.nucleoid.isekai.util.VoidWorldProgressListener;
...
public final class RuntimeWorldConfig {
    private long seed = 0;
    private ResourceKey<DimensionType> dimensionTypeKey = IsekaiInitializer.DEFAULT_TYPE;
    ...
    private ChunkProgressListener worldGenerationProgressListener = VoidWorldProgressListener.INSTANCE;
    ...
    public ChunkProgressListener getWorldGenerationProgressListener() {
        return this.worldGenerationProgressListener;
    }

    public void setWorldGenerationProgressListener(ChunkProgressListener listener) {
